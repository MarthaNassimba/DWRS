...
<li><a href="#"><i class="fa fa-users"></i> Domestic Workers</a>
					<ul>
						<li><a href="post-amaid.php">Post a Domestic Worker</a></li>
						<li><a href="manage-maids.php">Manage Domestic Workers</a></li>
					</ul>
				</li>
