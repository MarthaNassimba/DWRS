...
<title>TRAM RECRUITMENT COMPANY | Domestic Workers Listing</title>
<!--Bootstrap -->
...
$sql = "SELECT tblmaids.id from tblmaids 
join tblcategory on tblcategory.id=tblmaids.categoryname 
where tblmaids.names=:search || tblmaids.education=:search || tblcategory.CategoryName=:search || tblmaids.tribe=:search";
...
<?php 
$sql = "SELECT tblmaids.*,tblcategory.CategoryName,tblcategory.id as bid  from tblmaids 
join tblcategory on tblcategory.id=tblmaids.categoryname 
where tblmaids.names=:search || tblmaids.education=:search || tblcategory.CategoryName=:search || tblmaids.tribe=:search || tblmaids.address=:search";
$query = $dbh -> prepare($sql);
$query -> bindParam(':search',$searchdata, PDO::PARAM_STR);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
