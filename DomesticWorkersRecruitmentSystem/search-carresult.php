...
$sql = "SELECT id from tblmaids where tblmaids.categoryname=:category and tblmaids.education=:education";
...
$sql = "SELECT tblmaids.*,tblcategory.CategoryName,tblcategory.id as bid  from tblmaids join tblcategory on tblcategory.id=tblmaids.categoryname where tblmaids.categoryname=:category and tblmaids.education=:education";
$query = $dbh -> prepare($sql);
$query -> bindParam(':category',$category, PDO::PARAM_STR);
$query -> bindParam(':education',$education, PDO::PARAM_STR);
$query->execute();
...
<?php }} ?>
              ...
              <div class="form-group select" name="education">
